      ...
      <div className="relative bg-white rounded-lg shadow dark:bg-stone-700">
        <div className="flex flex-col items-start justify-between px-6 py-4">
          <p className="text-gray-800 dark:text-stone-200 text-base ">
            Have multiple AVA Knowledge Chat instances or simply want to backup or
  ...
  return (
    ...
    >
      <p className="text-gray-800 dark:text-stone-200 group-hover:text-gray-800 text-lg">
        Export AVA Knowledge Chat data
      </p>
    </button>
  );
}
...
function ImportData() {
  ...
  return (
    <>
      ...
      >
        <p className="text-gray-800 dark:text-stone-200 group-hover:text-gray-800 text-lg">
          Import AVA Knowledge Chat data
        </p>
        <p className="text-gray-800 dark:text-stone-200 group-hover:text-gray-800 text-xs italic">
          this must be an export from an AVA Knowledge Chat instance.
        </p>
      </button>
    </>
  );
