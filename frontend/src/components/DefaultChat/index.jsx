...
export default function DefaultChatContainer() {
  ...
  const MESSAGES = [
    <React.Fragment>
      ...
      >
        <div className="p-4 max-w-full md:max-w-[75%] bg-stone-100 dark:bg-stone-700 rounded-b-2xl rounded-tr-2xl rounded-tl-sm">
          <p className="text-slate-800 dark:text-slate-200 font-[500] md:font-semibold text-sm md:text-base">
            Welcome to AVA Knowledge Chat, AVA Knowledge Chat is an AI tool by
            AVA Intelligence that turns <i>anything</i> into a trained chatbot you
            can query and chat with. AVA Knowledge Chat is a BYOK (bring-your-own-keys)
    ...
    <React.Fragment>
      ...
      >
        <div className="p-4 max-w-full md:max-w-[75%] bg-stone-100 dark:bg-stone-700 rounded-b-2xl rounded-tr-2xl rounded-tl-sm">
          <p className="text-slate-800 dark:text-slate-200 font-[500] md:font-semibold text-sm md:text-base">
          AVA Knowledge Chat is the easiest way to put powerful AI products like
    ...
    <React.Fragment>
      ...
      >
        <div className="p-4 max-w-full md:max-w-[75%] bg-stone-100 dark:bg-stone-700 rounded-b-2xl rounded-tr-2xl rounded-tl-sm">
          <p className="text-slate-800 dark:text-slate-200 font-[500] md:font-semibold text-sm md:text-base">
          AVA Knowledge Chat can run totally locally on your machine with little
            overhead you wont even notice it's there! No GPU needed. Cloud and
            on-premises installation is available as well.
            <br />
            The AI tooling ecosystem gets more powerful everyday. AVA Knowledge Chat
    ...
    <React.Fragment>
      ...
      >
        <div className="p-4 max-w-full md:max-w-[75%] bg-stone-100 dark:bg-stone-700 rounded-b-2xl rounded-tr-2xl rounded-tl-sm">
          <p className="text-slate-800 dark:text-slate-200 font-[500] md:font-semibold text-sm md:text-base">
          AVA Knowledge Chat is more than a smarter Dropbox.
            <br />
            <br />
            AVA Knowledge Chat offers two ways of talking with your data:
            <br />
            <br />
